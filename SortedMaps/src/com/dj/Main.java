...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        addPurchases("Mary Martin", python, 149.99);
        addPurchases("Joe Jones", jmc, 149.99);
        addPurchases("Bill Brown", python, 119.99);

        addPurchases("Chuck Cheese", python, 119.99);
        addPurchases("Davy Jones", jmc, 139.99);
        addPurchases("Eva East", python, 139.99);
        addPurchases("Fred Forker", jmc, 139.99);
        addPurchases("Greg Brady", python, 129.99);
