...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Card> kingsOflCubs = Collections.nCopies(13, kingOfClubs);
        Card.printDeck(kingsOflCubs  , "King of Clubs  ",1);
...
//        cards.addAll(cardArray);
        ...
        Collections.copy(cards, kingsOflCubs);
        Card.printDeck(cards, "Card Collection with Kings Copied",2);

        cards = List.copyOf(kingsOflCubs);
        Card.printDeck(cards, "List of Kings",1);
...
//        Collections.shuffle(deck);
        ...
        var sortBySuit  = Comparator.comparing(Card:: suit).thenComparing(Card::suit);
