...
//                (previos, current) -> previos.mergeContactData(current)
//                    System.out.println("prev: " + previos + " : current " + current);
//                    Contact merged = previos.mergeContactData(current);
...
//                }
        ...
        if (success){
            ...
            System.out.printf("Did not match key: %s and value: %s %n".formatted("Daisy Duck", daisy));
        }
        contacts.forEach((k, v) -> System.out.printf("key= " + k + ", value=" + v));
    }
